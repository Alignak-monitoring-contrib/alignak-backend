...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak-Backend thanks to the fpm
...
pkg_name="${python_prefix}-alignak-backend"
pkg_description="Alignak backend, REST API and MongoDB backend for Alignak"
